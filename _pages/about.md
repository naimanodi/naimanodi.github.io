...
I have worked as a Student Assistant in the Anglistik Department at the University of Trier, focusing on the field of Speaker Diarization and machine speaker identification. 🎙️
Contributed to the Mismatch Condition in Machine Speaker Identification project, where I explore ways to improve recognition accuracy in challenging acoustic conditions. 👭
Explored machine learning models, integrating feature extraction and noise robustness techniques to enhance speaker recognition performance across diverse acoustic environments. 🔍
The work is under review in the "Problems of Forensic Sciences" Journal under the title "Challenges for Auditory and Automatic Speaker Identification: Evaluating Cases of Highly Similar Voices"
